...
(function() {
    ...
    var loadChat = function(cb) {
        if (!cb) cb = function() {};
        $.get('https://cdn.rawgit.com/mchineboy/source/5ae502a/lang/langIndex.json', function(json) {
    ...
    var basicBot = {
        ...
        settings: {
            ...
            tokers: [],
            blacklists: {
                NSFW: 'https://cdn.rawgit.com/mchineboy/source/5ae502a/blacklists/NSFWlist.json',
                OP: 'https://cdn.rawgit.com/mchineboy/source/5ae502a/blacklists/OPlist.json',
                BANNED: 'https://cdn.rawgit.com/mchineboy/source/5ae502a/blacklists/BANNEDlist.json'
            }
        },
        room: {
            name: null,
